...
<head>
        <title>Web Arc</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/controle/verificarLogin">
            ...
            $(document).ready(function(){
                ...
                $("#formLogin").validate({
                   ...
                   submitHandler: function( form ){       
                        ...
                        $.ajax({
                          type: "POST",
                          url: "<?php echo base_url();?>index.php/controle/verificarLogin?ajax=true",
                          data: dados,
                          dataType: 'json',
                          success: function(data)
                          {
                            if(data.result == true){
                                window.location.href = "<?php echo base_url();?>index.php/controle";
                            }
                            else{
