...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="<?php echo base_url();?>index.php/controle/minhaConta"><i class="icon icon-star"></i> <span class="text">Minha Conta</span></a></li>
    <li class=""><a title="" href="<?php echo base_url();?>index.php/controle/sair"><i class="icon icon-share-alt"></i> <span class="text">Sair do Sistema</span></a></li>
  </ul>
</div>

<!--start-top-serch-->
<div id="search">
  <form action="<?php echo base_url()?>index.php/controle/pesquisar">
        ...
        <li class="submenu <?php if(isset($menuConfiguracoes)){echo 'active open';};?>">
          ...
          <ul>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){ ?>
                <li><a href="<?php echo base_url()?>index.php/controle/emitente">Emitente</a></li>
            <?php } ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){ ?>
                <li><a href="<?php echo base_url()?>index.php/controle/backup">Backup</a></li>
            <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Web Arc</div>
</div>
<!--end-Footer-part-->
