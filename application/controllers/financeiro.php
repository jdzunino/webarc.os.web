...
class Financeiro extends CI_Controller
{
    ...
    public function lancamentos()
    {
        ...
        $this->data['parcelas'] = $this->financeiro_model->get('lancamentos', 'idLancamentos,descricao,valor,data_vencimento,data_pagamento,baixado,cliente_fornecedor,tipo,forma_pgto', $where, $config['per_page'], $this->input->get('per_page'));
    ...
    {
        return array(
            date("Y-m-d", strtotime("-7 day", strtotime("now"))),
