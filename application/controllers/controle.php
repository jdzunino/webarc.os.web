...
class Controle extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['ordens'] = $this->controle_model->getOsAbertas();
        $this->data['produtos'] = $this->controle_model->getProdutosMinimo();
        $this->data['os'] = $this->controle_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->controle_model->getEstatisticasFinanceiro();
    ...
    public function emitente(){   
        ...
        $data['dados'] = $this->controle_model->getEmitente();
        $data['view'] = 'controle/emitente';
    ...
    public function cadastrarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->controle_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email, $logo);
            if($retorno){
    ...
    public function editarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->controle_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email);
            if($retorno){
    ...
    public function editarLogo(){
        ...
        $retorno = $this->controle_model->editLogo($id, $logo);
        if($retorno){
